"""
Django settings for project_gestion_memoire project.
...
SECRET_KEY = '$u=os7ol&uh-om+z_i01qmms_!jl0)q++s3_or&ei4a93vfyf+'
...
WSGI_APPLICATION = 'project_gestion_memoire.wsgi.application'
